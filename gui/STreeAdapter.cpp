...
BOOL STreeAdapter::OnButtonConnClick(EventCmd* pEvt)
{
...
BOOL STreeAdapter::OnButtonDisconnClick(EventCmd* pEvt)
{
    auto* pBtn = sobj_cast<SButton>(pEvt->Sender());
    ItemInfo& ii = CSTree<SOUI::STreeAdapterBase<ItemData>::ItemInfo>::GetItemRef(pBtn->GetUserData());
...
BOOL STreeAdapter::OnButtonReconnClick(EventCmd* pEvt)
{
    auto* pBtn = sobj_cast<SButton>(pEvt->Sender());
    ItemInfo& ii = CSTree<SOUI::STreeAdapterBase<ItemData>::ItemInfo>::GetItemRef(pBtn->GetUserData());
...
BOOL STreeAdapter::OnButtonOptionClick(EventCmd* pEvt)
{
    return true;
}

BOOL STreeAdapter::OnButtonStatusClick(EventCmd* pEvt)
{
    TCHAR pageName[16];
    auto* pBtn = sobj_cast<SButton>(pEvt->Sender());
    ItemInfo& ii = CSTree<SOUI::STreeAdapterBase<ItemData>::ItemInfo>::GetItemRef(pBtn->GetUserData());
...
BOOL STreeAdapter::OnButtonLogviewClick(EventCmd* pEvt)
{
    auto* pBtn = sobj_cast<SButton>(pEvt->Sender());
    ItemInfo& ii = CSTree<SOUI::STreeAdapterBase<ItemData>::ItemInfo>::GetItemRef(pBtn->GetUserData());
